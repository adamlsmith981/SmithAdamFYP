...
if __name__ == '__main__':
    ...
    path = "/Users/adamsmith/Documents/GitHub/PH30036_AdamSmith/FYP/Ta2CO/ConvergenceTesting/lat_const/lat_const_CT"
    outputfile_end = ".out"
    ...
    new_f.write("Results for the lattice constant convegence in Ta2CO\n\nlattice constant (bohr)           total energy  (Ry)\n")
