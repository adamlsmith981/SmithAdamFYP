...
if __name__ == '__main__':
    ...
    path = "/Users/adamsmith/Documents/GitHub/PH30036_AdamSmith/FYP/Ta2CF2/ConvergenceTesting/lat_const_CT/lat_const_CT"
    outputfile_end = ".out"
    ...
    new_f.write("Results for the lattice constant convegence in Ta2C\n\nlattice constant (Angstrom)           total energy / Ry\n")
